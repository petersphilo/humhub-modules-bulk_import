        ...
        <table class="table">
            ...
            <?php foreach($invalidImports as $data) { ?>
                <tr>
                    ...
                    <td><?php if (array_key_exists('country',$data)){echo $data['country'];} ?></td>
                    <td><?php if (array_key_exists('space_names',$data)){echo implode(",", $data['space_names']);} ?></td>
                    <td><?php if (array_key_exists('previousid',$data)){echo $data['previousid'];} ?></td>
                </tr>
            <?php } ?>
        </table>
